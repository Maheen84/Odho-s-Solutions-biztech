...
export default function Home() {
  ...
  const projects = [
    ...
    {
      logo: "/assets/WhatsApp Image 2026-05-15 at 9.44.39 PM.jpeg",
      title: "Master Avocado Oil",
      desc: "A premium e-commerce website built to showcase pure avocado oil products, marketplace listings, and brand storytelling..",
      tags: ["React", "Dashboard", "Data Visualization", "API"],
      sub: "Master Avocado Oil Website Design",
